...
class ReservationController extends Controller
{
    ...
    public function select_reservation($current){
        ...
        $reservations = DB::table("reservations")
            ...
            ->join("provider_registers", "provider_registers.id", "branches.provider_id")
            ->join("users", "users.id", "reservations.user_id")
/*            ->leftjoin("images", "images.id", "users.image_id")*/
            ->join("reservations_statuses", "reservations_statuses.id", "reservations.status_id")
            ...
            ->select(
                ...
                "reservations_statuses.".LaravelLocalization::getCurrentLocale()."_name AS status_name",
                "reservations_statuses.id AS status_id"
            )
            ->paginate(10,['*'], $page);
...
/*            ->leftjoin("images", "images.id", "users.image_id")*/
    ...
    public function add_reservation($id, $type){
        ...
        return view("site.reservation.add-reservation", $data);
