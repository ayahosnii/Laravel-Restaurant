                                ...
                                <li class="has-dropdown">
                                    ...
                                    <ul style="width:170px">
                                        ...
                                        <li class="has-dropdown has-dropdown--ul-left-100">
                                            ...
                                            <ul style="width:200px">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="empty-{{route('site.cart.index')}}">Empty Cart</a></li>
                                                <li>
                                        ...
                                        <li>
                                            ...
                                            <a href="{{route('site.cart.index')}}">Cart</a></li>
                                        <li>
                                    ...
                                    <div class="mini-cart">
                                        ...
                                        <div class="mini-product-stat">
                                            ...
                                            <div class="mini-action">
                                                ...
                                                <a class="mini-link btn--e-transparent-secondary-b-2" href="{{route('site.cart.index')}}">VIEW CART</a></div>
                                        </div>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            &lt;!&ndash;====== End - Product Detail ======&ndash;&gt;
                        </div>
                        <div class="col-lg-7">

                            &lt;!&ndash;====== Product Right Side Details ======&ndash;&gt;
                            <div class="pd-detail">
                                <div>
                            ...
                            &lt;!&ndash;====== End - Product Right Side Details ======&ndash;&gt;
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div class="s-option">
                                ...
                                <div class="s-option__link-box">
                                    ...
                                    <a class="s-option__link btn&#45;&#45;e-white-brand-shadow" href="{{route('site.cart.index')}}">VIEW CART</a>
