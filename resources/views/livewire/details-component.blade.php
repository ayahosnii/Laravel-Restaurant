            ...
            <div class="col">
                <div class="pro-page-tab">
                    <ul class="nav nav-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="https://spacingtech.com/html/vegist-final/vegist/product.html#tab-3">Video</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade show" id="tab-3">
                            <div class="embed-responsive embed-responsive-16by9">
                                <iframe height="630" src="./details-Vegist_files/0etCKCAsImI.html" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                            </div>
                        </div>
