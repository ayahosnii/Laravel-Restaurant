                                    ...
                                    <div class="wishlist-all-pro">
                                        <div class="wishlist-pro">
                                            <div class="wishlist-pro-image">
                                                <a href="{{route('meal.details', $item->model->name)}}"><img src="{{$item->model->image}}" style="width: 200px; height: 200px" class="img-fluid" alt="image"></a>
                                            </div>
                                            <div class="pro-details">
                                                <h4><a href="{{route('meal.details', $item->model->name)}}">{{$item->name}}</a></h4>
