                    ...
                    <div class="vendor-filter">
                        ...
                        <ul class="all-vendor collapse" id="vendor">
                            @foreach($providers as $provider)
                                <li class="f-vendor">
                                    <input type="checkbox" wire:model="filterProviders{{--.{{$provider->id}}--}}" value="{{$provider->id}}">
                                    ...
                                    <li class="grid-items">
                                        <div class="tred-pro">
                                            <div class="tr-pro-img">
                                                <a href="{{--route('meal.details',['name'=>$product->product->name])--}}">
                                                    <img class="img-fluid" style="height: 300px; width: 500px"  src="{{asset($product->product->image)}}" alt="pro-img1">
                                                    <img class="img-fluid additional-image" style="height: 300px; width: 500px" src="{{asset($product->product->image)}}" alt="additional image">
                                                </a>
                                            </div>
                                            <div class="Pro-lable">
                                        ...
                                        <div class="caption">
                                            <a href="{{route('meal.details',['name'=>$product->product->name])}})}}" class="sb-menu-item sb-menu-item-sm sb-mb-15">
                                                <div class="sb-card-tp">
{{--                                                    <h4 class="sb-card-title">{{$product->product->name}} / {{$product->product->provider->name}}</h4>--}}
{{--                                                    <div class="sb-price"><sub>£{{$product->product->price}}</sub> </div>--}}
                                                </div>
                                            </a>
                                        </div>
                                    </li>
