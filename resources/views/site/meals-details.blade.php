                ...
                <div class="row">
                    <div class="col-lg-6 col-xl-6 col-md-6 col-12 col-xs-12 larg-image">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade active show" id="image-44">
                                <a href="javascript:void(0)" class="long-img">
                                    <figure class="zoom" onmousemove="zoom(event)" style="background-image: url({{$meal->image}})">
                                        <img src="{{asset($meal->image)}}" style="height: 460px;" class="img-fluid" alt="image">
                                    </figure>
                                </a>
                            </div>
                    ...
                    <div class="col-lg-6 col-xl-6 col-md-6 col-12 col-xs-12 pro-info">
                        ...
                        <div class="pro-availabale">
                            ...
                            <span class="pro-instock"> @if($meal->stock_status ==  1)In Stock @else Out Stock @endif</span>
                        </div>
                        <div class="pro-availabale">
                            <span class="available">Restaurant:</span>
                            <span class="pro-instock"><a href="{{route('restaurant.details', $meal->provider->user_name)}}">{{$meal->provider->name}}</a></span>
                        </div>
                        <div class="pro-availabale">
