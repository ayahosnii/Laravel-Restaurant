                        ...
                        <div class="card border-grey border-lighten-3 m-0">
                            <div class="card-header border-0">
                                <div class="card-title text-center">
                                    <div class="p-1">
                                        <img src="{{asset('assets/img/logo1.png')}}" alt="branding logo">
                                    </div>
                                </div>
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal form-simple" action="{{route('admin.login')}}" method="post">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left mb-0">
                                            <input name="email" type="text" class="form-control form-control-lg input-lg" id="email" placeholder="Your Email"
                                                   required>
