                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <p class="text-muted">Total orders: {{$countOrders}}</p>
                            </div>
                        </div>
                        <div class="card-content">
                        ...
                        <div class="card-content">
                            <div class="table-responsive">
                                <table class="table table-de mb-0">
                                    ...
                                    <tr>
                                        <td>{{$bestseller->meal->provider->name}}</td>
                                        <td>{{$bestseller->meal->name}}</td>
                                        <td><img src="{{$bestseller->meal->image}}" alt="" style="width: 60px; height=60px"></td>
                                    </tr>
                                    @endforeach
                                    </tbody>
                                </table>
