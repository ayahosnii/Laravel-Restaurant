                                    ...
                                    <div class="megamenu-content">
                                        <div class="mainwrap">
                                            <ul class="main-menu">
                                                ...
                                                <li class="menu-link parent">
                                                    <a href="javascript:void(0)" class="link-title">
                                                        <span class="sp-link-title">hey</span>
                                                        <i class="fa fa-angle-down"></i>
                                                    </a>
                                    ...
                                    <ul class="main-menu">
                                        ...
                                        <li class="menu-link parent">
                                            ...
                                            <ul class="dropdown-submenu banner-menu collapse" id="collapse-banner-menu1">
                                                ...
                                                <li class="menu-banner">
                                                    <a href="{{route('sales')}}" class="menu-banner-img"><img src="{{asset('assets/img/menu-banner03.jpg')}}" alt="mneu image" class="img-fluid"></a>
                                                    <a href="{{route('sales')}}" class="menu-banner-title"><span>Featured product</span></a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-link parent">
                                            <a href="javascript:void(0)" class="link-title">
                                                <span class="sp-link-title">Hi</span>
                                                <i class="fa fa-angle-down"></i>
                                            </a>
                                        ...
                                        <li class="menu-link">
                                            <a href="javascript:void(0)" class="link-title">
                                                <span class="sp-link-title">try <span class="hot">Hot</span></span>
                                            </a>
                                        </li>
                                    </ul>
                                </div>
